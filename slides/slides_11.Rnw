...
\begin{center}
{[}See \href{https://docs.google.com/document/d/1d_eGgmsByZohQslKIirVflpDUzvUiXZFAeej3PvTDzU/edit?usp=sharing}{syllabus} {]}
\end{center}
...
\begin{itemize}
\item Google! \pause
\item Ask on our course StackOverflow: \url{https://stackoverflow.com/c/sosc13200-w22-3/questions} \pause {[}I'll send invites shortly{]}  \pause
...
\begin{itemize}
\item \url{https://github.com/UChicago-pol-methods/SOSC13200-W22}\pause
