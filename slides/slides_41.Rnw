...
\begin{itemize}
\item numerator: the difference in earning by quarter of birth  
...
%-------------------------------------------------------------------------------%
\begin{frame}{Wald estimator}
Identification for the Wald estimator:
\begin{itemize}
\item ``Consistent'' estimator for returns to education if season of birth is not correlated with other determinants of earnings besides education \pause
\item Do you think this is a valid assumption?
\end{itemize}
...
\begin{centering}
\includegraphics[width = .6\textwidth]{../assets/angrist-kruegert3.png}
\end{centering}
