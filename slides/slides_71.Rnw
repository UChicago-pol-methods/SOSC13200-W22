...
$$
\E[Y | X_1 = x_1, X_2 = x_2, \dots,  X_K = x_K] = g(x_1, x_2, \dots, x_K)
$$
...
\item Consider a \textit{causal} model, where $D_i$ is a manipulated binary treatment variable:
$$
...
$$
Y = \gamma_0 + \gamma_1 D_1 + \beta_1 X_1 + \beta_2 X_2 + \epsilon
$$\pause
