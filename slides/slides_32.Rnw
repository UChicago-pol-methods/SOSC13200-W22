...
\begin{document}
\SweaveOpts{concordance=TRUE, prefix.string = figs/}
...
% <!-\item ## Applications -->
% 
% <!-\item Applications with one of our datasets, using stat_summary() to get summaries by group (recall R4DS 3.7, statistical transformations; 5.6.4 Useful summary functions) -->
% 
% 
