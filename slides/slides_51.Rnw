...
\begin{tabular}{lccccc}
& $Y_i(0)$ & $Y_i(1)$ & $D_i$ & $Y_i$ & $\tau_i$ \\
Village 1 & \textcolor{red}{15} & 15 & \textcolor{blue}{1} & 15 & \textcolor{red}{0} \\
...
{\textbf{Average}} & \color{blue}{{\textbf{19}}} & \color{blue}{{\textbf{15}}} & & &
\end{tabular}
\end{table}
\pause
$$
...
\item There are seven villages, and we say that exactly two will get treatment. Each village is assigned treatment with equal probability.\pause
